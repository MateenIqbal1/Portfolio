    ...
    return (
        <div className='w-full bg-transparent text-gray-200 shadow-lg p-4 md:p-6'>
            <div className="max-w-6xl mx-auto flex flex-col items-center">
                <h1 className='text-3xl md:text-4xl font-semibold text-transparent bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500 pb-6 md:pb-8'>
                    About me
                </h1>
                ...
                <div className="w-full grid grid-cols-2 md:grid-cols-3 gap-4 md:gap-6">
                    ...
                    <div className='flex flex-col items-center'>
                        ...
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="flex items-center my-3 text-white hover:text-gray-300 transition-colors text-center"
                        >
                            <SiGmail className="text-xl mr-2" />
                            <span className='break-all'>mateeniqbal840@gmail.com</span>
                        </a>
                    </div>
                </div>
            </div>
